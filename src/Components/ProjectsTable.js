...
//       <TableContainer
//         component={Paper}
//         style={{ maxHeight: 300, marginTop: 15, marginBottom: 30 }}
//       >
...
const ProjectTable = ({ onShowNewProjectForm }) => {
  return (
    <div>
      <Grid container alignItems="center">
        <Grid item xs={12} sm={6}>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <Button
                ...
                onClick={onShowNewProjectForm} // Call onShowNewProjectForm when button is clicked
              >
                Create New Project
              </Button>
            </Grid>
